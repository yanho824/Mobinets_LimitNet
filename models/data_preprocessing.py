...
class CustomDataset(Dataset):
    def __init__(self, image_transform = None, saliancy_transform = None, train = None):
        self.train_image_list = sorted(os.listdir('SalData/train/image/'))
        self.train_saliancy_list = sorted(os.listdir('SalData/train/mask/'))
        ...
        self.test_image_list = sorted(os.listdir('SalData/test/image/'))
        self.test_saliancy_list = sorted(os.listdir('SalData/test/mask/'))
    ...
    def __getitem__(self, index):
        if self.train:
            img_path = os.path.join('SalData/train/image/', self.train_image_list[index])
            saliancy_path = os.path.join('SalData/train/mask/', self.train_saliancy_list[index])
            ...
            img_path = os.path.join('SalData/test/image/', self.test_image_list[index])
            saliancy_path = os.path.join('SalData/test/mask/', self.test_saliancy_list[index])
